...
| Trigger level | **S2** | Digital, SPI3 register `0x08`, an ADC code. Re-armed at boot. Transfer measured 2026-09-22 (EXP-56): the comparator fires at code − 28 on ranges 5 and 7 alike. No UI control reaches it yet. |
