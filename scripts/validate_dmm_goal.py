...
def verify_legacy_top_level_dmm_protocol_boundaries() -> dict[str, Any]:
    ...
    required = {
        ...
        "reverse_engineering/analysis_v120/fpga_task_annotated.c": [
            ...
            "Historical warning: older annotations called this calibration",
...
def verify_re_coverage() -> dict[str, Any]:
    ...
    required_terms = [
        ...
        "frequency/acquisition command-family evidence",
        "timebase/packed-state command-family evidence",
        "not DMM physical range proof",
        "not capacitance/temperature physical range proof",
        "not a DMM calibration or range source",
        "not a continuity/diode physical frontend proof",
        ...
        "not DMM ms[0x02]/ms[0x03]",
        "Button/key debounce false `ms[0x02]` guard", "0x08039374",
        "0x0803947A", "0x20002D50", "0x20002D58", "0x08046528",
        "[r4,#2] is the third key-column debounce counter",
        "not DMM `ms[0x02]`",
